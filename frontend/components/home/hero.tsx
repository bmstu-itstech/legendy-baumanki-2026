...
export function Hero() {
  return (
    ...
    >
      <Star className="pointer-events-none absolute -bottom-3 left-[4%] z-[2] size-[58px] text-white/90 sm:size-[72px] lg:bottom-6 lg:left-[3%] lg:size-[126px]" />
      <Star className="pointer-events-none absolute bottom-2 left-1/2 z-[2] size-[60px] text-white/90 sm:size-[76px] lg:bottom-10 lg:left-[55%] lg:size-[94px]" />
